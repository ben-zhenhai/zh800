...
void *FileFunction(void *argument)
{
    ...
    short checkNetworkStatusPeriodValue = 0;
    ...
    while(FileFlag)   
    {
        ...
        checkNetworkStatusPeriodValue = (checkNetworkStatusPeriodValue + 1) % 40;
        if(checkNetworkStatusPeriodValue == 0)
        { 
...
void * WatchDogFunction(void *argument)
{
    pthread_t SerialThread, FileThread, TelnetControlThread, FTPThread;
    int rc = 0;
    FILE *fptr;
    struct timeval now;
    struct ifreq ifr;
